...
import 'home_set_password_model.dart';
export 'home_set_password_model.dart';

class HomeSetPasswordWidget extends StatefulWidget {
  const HomeSetPasswordWidget({Key? key}) : super(key: key);

  @override
  _HomeSetPasswordWidgetState createState() => _HomeSetPasswordWidgetState();
}

class _HomeSetPasswordWidgetState extends State<HomeSetPasswordWidget> {
  late HomeSetPasswordModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeSetPasswordModel());
  }

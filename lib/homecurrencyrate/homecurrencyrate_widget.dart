...
import 'homecurrencyrate_model.dart';
export 'homecurrencyrate_model.dart';

class HomecurrencyrateWidget extends StatefulWidget {
  const HomecurrencyrateWidget({Key? key}) : super(key: key);

  @override
  _HomecurrencyrateWidgetState createState() => _HomecurrencyrateWidgetState();
}

class _HomecurrencyrateWidgetState extends State<HomecurrencyrateWidget> {
  late HomecurrencyrateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomecurrencyrateModel());
  }

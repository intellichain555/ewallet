...
import 'home_tip_model.dart';
export 'home_tip_model.dart';

class HomeTipWidget extends StatefulWidget {
  const HomeTipWidget({Key? key}) : super(key: key);

  @override
  _HomeTipWidgetState createState() => _HomeTipWidgetState();
}

class _HomeTipWidgetState extends State<HomeTipWidget> {
  late HomeTipModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeTipModel());
  }
                  ...
                  children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: Image.asset(
                                    'assets/images/home_financing.png',
                                  ).image,
                                ),
                              ),
                            ),
                    ...
                    Container(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.asset(
                          'assets/images/usdt_financing_bottom.png',
                          width: 300.0,
                          height: 200.0,
                          fit: BoxFit.contain,
                        ),

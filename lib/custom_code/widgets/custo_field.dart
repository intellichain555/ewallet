...
class CustoField extends StatefulWidget {
  const CustoField({
    Key? key,
    this.width,
    this.height,
  ...
  @override
  _CustoFieldState createState() => _CustoFieldState();
}

class _CustoFieldState extends State<CustoField> {
    ...
    return Container(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            labelText: 'Name ',
            suffixIcon: true //_model.textController!.text.isNotEmpty
                ? InkWell(
                    onTap: () async {

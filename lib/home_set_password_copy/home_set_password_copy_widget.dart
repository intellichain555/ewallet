...
import 'home_set_password_copy_model.dart';
export 'home_set_password_copy_model.dart';

class HomeSetPasswordCopyWidget extends StatefulWidget {
  const HomeSetPasswordCopyWidget({Key? key}) : super(key: key);

  @override
  _HomeSetPasswordCopyWidgetState createState() =>
      _HomeSetPasswordCopyWidgetState();
}

class _HomeSetPasswordCopyWidgetState extends State<HomeSetPasswordCopyWidget> {
  late HomeSetPasswordCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeSetPasswordCopyModel());
  }
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Text(
                                          'You have not set a payment password, please set it as soon as possible',
